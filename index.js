...
class ReactWizard extends React.Component {
  constructor(props) {
    ...
    if (this.props.headerTextColor !== undefined)
      this.headerTextColor = this.props.headerTextColor;
    else this.headerTextColor = "#fff";
  }
      ...
      <div className="wizard-container" ref="wizard">
        <Card className="card card-wizard active" data-color={this.state.color}>
          ...
          this.props.description !== undefined ? (
            ...
            >
              {this.props.title !== undefined ? (
                  <CardTitle tag="h3"><span style={this.getStyles()}>{this.props.title}</span></CardTitle>
              ) : null}
              {this.props.description !== undefined ? (

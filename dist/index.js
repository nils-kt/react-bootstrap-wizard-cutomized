...
var ReactWizard = /*#__PURE__*/ (function(_React$Component) {
  ...
  function ReactWizard(props) {
    ...
    _this.state = {
      ...
      width: width,
      wizardData:
          _this.props.wizardData !== undefined ? _this.props.wizardData : {},
      movingTabStyle: {
    ...
    _this.navigationStepChange = _this.navigationStepChange.bind(
        _assertThisInitialized(_this)
    );
    _this.refreshAnimation = _this.refreshAnimation.bind(
        _assertThisInitialized(_this)
    );
    _this.previousButtonClick = _this.previousButtonClick.bind(
        _assertThisInitialized(_this)
    );
    _this.previousButtonClick = _this.previousButtonClick.bind(
        _assertThisInitialized(_this)
    );
    _this.finishButtonClick = _this.finishButtonClick.bind(
        _assertThisInitialized(_this)
    );
    if (_this.props.headerTextColor !== undefined)
      _this.headerTextColor = _this.props.headerTextColor;
    else _this.headerTextColor = "#fff";
    return _this;
  }
        ...
        if (this.props.navSteps) {
          ...
          if (this.props.validate && key > this.state.currentStep) {
            for (var i = this.state.currentStep; i < key; i++) {
              if (
                  this.refs[this.props.steps[i].stepName].isValidated !==
                  undefined &&
...
ReactWizard.propTypes = {
  ...
  headerTextColor: _propTypes.default.string,
